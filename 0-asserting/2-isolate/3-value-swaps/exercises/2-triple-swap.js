...
console.assert(a === temp, 'Step 1.2');
a = c;
console.assert(a === 'x', 'Step 2.1');
console.assert(c === a, 'Step 2.2');
c = temp;
console.assert(c === 'y', 'Step 3.1');
console.assert(temp === c, 'Step 3.2');

temp = c;
console.assert(temp === 'y', 'Step 4.1');
console.assert(c === temp, 'Step 4.2');
c = b;
console.assert(c === 'z', 'Step 5.1');
console.assert(b === c, 'Step 5.2');
b = temp;
console.assert(b === 'y', 'Step 6.1');
console.assert(temp === b, 'Step 6.2');
